...
describe("test module", () => {
  it("login", () => {
    ...
    cy.wait(1000);
    application.typebirthDate("18-Jan-1979");
    cy.wait(3000);
    application.clickidentityType();
    cy.wait(1000);
    application.typenidNumber("8850660202");
    cy.wait(500);
    application.clicknext();
    cy.wait(500);

    Personalinfo.typenameBangla("হাসান আল মাসুদ");
    cy.wait(500);
    Personalinfo.typenameEnglish("Hasan Al Masud");
    cy.wait(500);
    Personalinfo.typefatherName("কুতুব উদ্দিন");
    cy.wait(500);
